...
### 급행 열차 순간이동 버그
 ...
 - 한국철도공사(코레일)가 노선의 일부 또는 전체를 관할하는 노선에서만 발생함. 1, 3, 4호선, 경의중앙선, 수인분당선, 경춘선에서 발생, 9호선에서는 발생하지 않음.
...
### 4호선 진접선 구간 정보 없음 (당고개 ~ 진접)
 ...
 - 본인들이 만든 앱에서는 진접선 구간도 잘 나오게 구현해놓고, 진접선 구간은 남양주시의 협조가 있어야 실시간 운행 정보를 제공할 수 있다고 답변함
