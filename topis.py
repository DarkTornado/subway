    ...
    def get_data(self, lineName, lineId):  # https://data.seoul.go.kr/dataList/OA-12601/A/1/datasetView.do
        ...
        if lineId == '1' or lineId == '4' or lineId == '5' or (lineId == '2' and len(json) == 0): 
            ...
            for no in data:
                ...
                # 4호선 상행 행선지 보정
                if data[no]['dest'] == '당고개':  # 서울시 API에 역명 번경 아직 미반영
                    data[no]['dest'] = '불암산'
                if data[no]['dest'] == '불암산' and trains[no]['dest'] == '진접':  # 진접행
                    data[no]['dest'] = '진접'
    ...
    def get_stn_list(self, lineId):
        ...
        if lineId == '4':
            return [{'stn':'진접','id':'1004000406'},{'stn':'오남','id':'1004000407'},{'stn':'별내별가람','id':'1004000408'},
                    {'stn':'불암산','id':'1004000409'},{'stn':'상계','id':'1004000410'},{'stn':'노원','id':'1004000411'},{'stn':'창동','id':'1004000412'},{'stn':'쌍문','id':'1004000413'},{'stn':'수유','id':'1004000414'},{'stn':'미아','id':'1004000415'},{'stn':'미아사거리','id':'1004000416'},{'stn':'길음','id':'1004000417'},{'stn':'성신여대입구','id':'1004000418'},{'stn':'한성대입구','id':'1004000419'},{'stn':'혜화','id':'1004000420'},{'stn':'동대문','id':'1004000421'},{'stn':'동대문역사문화공원','id':'1004000422'},{'stn':'충무로','id':'1004000423'},{'stn':'명동','id':'1004000424'},{'stn':'회현','id':'1004000425'},{'stn':'서울','id':'1004000426'},{'stn':'숙대입구','id':'1004000427'},{'stn':'삼각지','id':'1004000428'},{'stn':'신용산','id':'1004000429'},{'stn':'이촌','id':'1004000430'},{'stn':'동작','id':'1004000431'},{'stn':'총신대입구 (이수)','id':'1004000432'},
        ...
        if lineId == '151':
            return [
                # {'stn':'운정중앙','id':'1032000346'},{'stn':'킨텍스','id':'1032000347'},{'stn':'대곡','id':'1032000348'},{'stn':'창릉 (미개통)','id':'1032000349'},{'stn':'연신내','id':'1032000350'},{'stn':'서울역','id':'1032000351'},
                # {'stn':'삼성 (미개통)','id':'1032000352'},
                {'stn':'수서','id':'1032000353'},{'stn':'성남','id':'1032000354'},{'stn':'구성','id':'1032000355'},{'stn':'동탄','id':'1032000356'}
                ]
